...
import com.unbosque.sispart.app.empleados.dto.TipoDocumentoDto;
import com.unbosque.sispart.app.empleados.entity.TipoDocumento;
import com.unbosque.sispart.app.empleados.service.ITipoDocumentoService;
	...
	public ResponseEntity<?> createNacionalidades(@RequestBody TipoDocumentoDto tipoDocumentoDto) {
		...
		if (StringUtils.isBlank(tipoDocumentoDto.getTipDocumento()))
			return new ResponseEntity(
					new Mensaje("El campo tipo de documento es obligatorio."),
